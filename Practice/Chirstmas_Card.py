...
for x in x_position-x_seperation, x_position+x_seperation: 
    make_circle(snowman, x, y_positions[0] + y_offset, 20, "blue") 
...
text.write("Merry Chirstmas and ", font=("Apple Chancery", 30, "bold"), align="center") 
text.setposition(140, 140) 
text.color("dark green")
text.setposition(10,170) 
text.write("Happy New Year ", font=("Apple Chancery", 30, "bold"), align="center") 
text.setposition(140, 140) 
text.color("dark green") 
text.write("Long", font=("Avenir", 20, "bold"), align="right") 
text.color("black") 
text.setx(50) 
text.write("by", font=("Apple Chancery", 20, "bold"), align="right") 
text.hideturtle() 
